...
function MyAssignedTickets() {
  ...
  const fetchTickets = async () => {
    try {
      const res = await fetch(`${import.meta.env.VITE_SERVER_URL}/tickets/myassigned/${user._id}`, {
  ...
  const totalPages = Math.ceil(filteredTickets.length / ticketsPerPage);
    ...
    return (
      ...
      <h2 className="text-xl font-semibold mb-2 text-indigo-700">My Assigned Tickets</h2>
